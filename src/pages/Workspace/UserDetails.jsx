    ...
    return (
      <div className='h-full flex flex-col items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-6'>
        ...
        <Card className='w-full max-w-md'>
          <CardContent className='pt-6 flex flex-row items-center justify-center'>
            <TriangleAlertIcon className='text-muted-foreground px-1' />
        ...
        <Card className='shadow-lg border-0'>
          ...
          <CardContent className='pt-8'>
            <div className='flex flex-col items-center mb-8'>
              ...
              <p className='text-sm text-muted-foreground mt-1'>@{member?.userId?.username}</p>
            </div>
